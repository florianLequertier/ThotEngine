...
Skybox::Skybox()
{
    std::vector<Vertex> tab_data_vertexModel{
        ...
        //face z>0
        Vertex(glm::vec3(-0.5, 0.5, 0.5), glm::vec3(0,0,1), glm::vec2(2/4.f, 0.f) ),
        Vertex(glm::vec3(0.5, 0.5, 0.5), glm::vec3(0,0,1),  glm::vec2(1/4.f, 0.f) ),
        ...
        Vertex(glm::vec3(0.5, -0.5, -0.5), glm::vec3(0,0,-1), glm::vec2(1/4.f, 1.f) ),
        Vertex(glm::vec3(-0.5, -0.5, -0.5), glm::vec3(0,0,-1), glm::vec2(2/4.f, 1.f) ),
